...
<head>
  ...
  <title>Daftar Akun - BPS Provinsi Sumatera Utara</title>
...
<body>
  <header>
    ...
    <nav>
      ...
      <a href="register.php" class="active">Daftar Akun</a>
    </nav>
  </header>

  <main>
    <h2 style="text-align: center; color: #333">Daftar Akun Baru</h2>
    <p style="text-align:center; color:#666; font-size:14px; margin-top:-10px;">
      Akun baru otomatis berrole <strong>user</strong> (hanya bisa melihat data).<br />
      Untuk akses admin, hubungi administrator sistem.
    </p>
    ...
    <div class="kotak-form">
      <form name="formRegister" action="register_action.php" method="post">
        <table border="0" cellpadding="8" cellspacing="0">
          <tr>
            <td width="150"><label for="nama">Nama Lengkap:</label></td>
            <td><input type="text" id="nama" name="nama" required /></td>
          </tr>
          <tr>
            <td><label for="username">Username:</label></td>
            <td><input type="text" id="username" name="username" required minlength="4" /></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input type="password" id="konfirmasi" name="konfirmasi" required minlength="6" /></td>
          </tr>
          <tr>
            <td></td>
